module params
   ...
   type parameters
      ...
      double precision                  :: C                        = -123                 !  [m^0.5s^-1] Chezy coefficient
      double precision                  :: cf                       = -123                 !  [-] (advanced) Friction coefficient flow
...
contains
   ...
   subroutine all_input(par)
      ...
      if (par%gwflow==1) then
         ...
         par%gwnonh     = readkey_int ('params.txt','gwnonh',      0,           0,        1,strict=.true.)
