...
type clean_mpi.log
echo ##teamcity[progressMessage 'Cleaning MPI_netcdf_Release||Win32']
%devenv_path%\devenv.exe "%1\%2" /Clean "MPI_netcdf_Release|Win32" /Project xbeach /Out clean_mpi_netcdf.log
type clean_mpi_netcdf.log
...
echo ##teamcity[progressMessage 'Cleaning netcdf_Release||x64']
%devenv_path%\devenv.exe "%1\%2" /Clean "netcdf_Release|x64" /Project xbeach /Out clean_netcdf_x64.log
type clean_netcdf_x64.log
echo ##teamcity[progressMessage 'Cleaning MPI_Release||x64']
%devenv_path%\devenv.exe "%1\%2" /Clean "MPI_Release|x64" /Project xbeach /Out clean_mpi_x64.log
type clean_mpi_x64.log
echo ##teamcity[progressMessage 'Cleaning MPI_netcdf_Release||x64']
%devenv_path%\devenv.exe "%1\%2" /Clean "MPI_netcdf_Release|x64" /Project xbeach /Out clean_mpi_netcdf_x64.log
type clean_mpi_netcdf_x64.log
...
%devenv_path%\devenv.exe "%1\%2" /Build "Release|Win32" /Project xbeachlibrary_dynamic /Out build_exe.log
...
%devenv_path%\devenv.exe "%1\%2" /Build "netcdf_Release|Win32" /Project xbeachlibrary_dynamic /Out build_netcdf.log
...
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_Release|Win32" /Project xbeachlibrary_dynamic /Out build_mpi.log
type build_mpi.log
echo ##teamcity[progressMessage 'Building MPI_netcdf_Release||Win32']
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_netcdf_Release|Win32" /Project xbeach /Out build_mpi_netcdf.log
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_netcdf_Release|Win32" /Project xbeachlibrary_dynamic /Out build_mpi_netcdf.log
type build_mpi_netcdf.log
...
%devenv_path%\devenv.exe "%1\%2" /Build "Release|x64" /Project xbeachlibrary_dynamic /Out build_release_x64.log
type build_release_x64.log
echo ##teamcity[progressMessage 'Building netcdf_Release||x64']
%devenv_path%\devenv.exe "%1\%2" /Build "netcdf_Release|x64" /Project xbeach /Out build_netcdf_x64.log
%devenv_path%\devenv.exe "%1\%2" /Build "netcdf_Release|x64" /Project xbeachlibrary_dynamic /Out build_netcdf_x64.log
type build_netcdf_x64.log
...
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_Release|x64" /Project xbeachlibrary_dynamic /Out build_mpi_x64.log
type build_mpi_x64.log
echo ##teamcity[progressMessage 'Building MPI_netcdf_Release||x64']
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_netcdf_Release|x64" /Project xbeach /Out build_mpi_netcdf_x64.log
%devenv_path%\devenv.exe "%1\%2" /Build "MPI_netcdf_Release|x64" /Project xbeachlibrary_dynamic /Out build_mpi_netcdf_x64.log
type build_mpi_netcdf_x64.log
